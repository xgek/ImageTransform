// src/lib.rs
/*
 * Core library for ImageTransform
 */
...
#[derive(Debug)]
pub struct ImageTransformProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ImageTransformProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ImageTransform processing");
    
    let mut processor = ImageTransformProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ImageTransformProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ImageTransformProcessor::new(false);
